...
public class GestoreFinestre {
	...
	@FXML
	public void switchFinestraProfiloRicercato() throws IOException {
	...
	public void switchFinestraCreaCommento() throws IOException {
        App.setRoot("FinestraCreaCommento");
	}
	
	@FXML
	public void switchFinestraReport() throws IOException {
        App.setRoot("FinestraReport");
	}
