...
public class ControllerGruppo implements Initializable{
	...
	public void setPulsanteRichiesta() {
		...
		if(statoRichiesta || GruppoDao.getGruppoCorrente().getUtenteCreatore().equals(UtenteDao.getUtenteCorrente())) {
			...
			if(statoRichiesta == false) {
				richiedi.setText("Richiedi di accedere");
			}else if(statoRichiesta == null){
				System.out.println("la richiesta e null");
